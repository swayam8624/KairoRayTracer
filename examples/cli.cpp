...
namespace
{
    ...
    {
        std::cout
            << "Usage: KairoRayTracerCLI <scene.kairo> [--mode whitted|normal|depth|shadow_mask|bvh_heatmap|albedo|primitive_id|uv|barycentric|accel_diff] [--output path] [--width px --height px] [--samples n] [--threads n]\n";
    }
}
